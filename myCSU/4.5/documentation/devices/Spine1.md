...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_WCC1_Ethernet53/1 | routed | - | 10.255.255.0/31 | default | 1500 | False | - | - |
| Ethernet2/1 | P2P_LINK_TO_WCC2_Ethernet53/1 | routed | - | 10.255.255.4/31 | default | 1500 | False | - | - |
...
router bgp 65100
   ...
   neighbor 10.255.255.1 description WCC1_Ethernet53/1
   neighbor 10.255.255.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.5 remote-as 65101
   neighbor 10.255.255.5 description WCC2_Ethernet53/1

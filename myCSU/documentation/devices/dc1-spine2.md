...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 129.82.52.21/24 | 129.82.52.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_DC1-LEAF1A_Ethernet54/1 | routed | - | 10.255.255.2/31 | default | 1500 | False | - | - |
| Ethernet2/1 | P2P_LINK_TO_DC1-LEAF1B_Ethernet54/1 | routed | - | 10.255.255.6/31 | default | 1500 | False | - | - |
...
interface Ethernet1/1
   description P2P_LINK_TO_DC1-LEAF1A_Ethernet54/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet2/1
   description P2P_LINK_TO_DC1-LEAF1B_Ethernet54/1
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65100
   ...
   neighbor 10.255.255.3 description dc1-leaf1a_Ethernet54/1
   neighbor 10.255.255.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.7 remote-as 65101
   neighbor 10.255.255.7 description dc1-leaf1b_Ethernet54/1

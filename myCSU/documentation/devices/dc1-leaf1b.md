...
| Ethernet49/1 | MLAG_PEER_dc1-leaf1a_Ethernet49/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 491 |
| Ethernet50/1 | MLAG_PEER_dc1-leaf1a_Ethernet50/1 | *trunk | *- | *- | *['LEAF_PEER_L3', 'MLAG'] | 491 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet53/1 | P2P_LINK_TO_DC1-SPINE1_Ethernet2/1 | routed | - | 10.255.255.5/31 | default | 1500 | False | - | - |
| Ethernet54/1 | P2P_LINK_TO_DC1-SPINE2_Ethernet2/1 | routed | - | 10.255.255.7/31 | default | 1500 | False | - | - |
...
interface Ethernet49/1
   description MLAG_PEER_dc1-leaf1a_Ethernet49/1
   no shutdown
   channel-group 491 mode active
!
interface Ethernet50/1
   description MLAG_PEER_dc1-leaf1a_Ethernet50/1
   no shutdown
   channel-group 491 mode active
!
...
| Port-Channel491 | MLAG_PEER_dc1-leaf1a_Po491 | switched | trunk | - | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel491
   description MLAG_PEER_dc1-leaf1a_Po491
   no shutdown
   switchport
   switchport mode trunk

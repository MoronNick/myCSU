...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 129.82.52.20/24 | 129.82.52.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1/1 | P2P_LINK_TO_DC1-LEAF1A_Ethernet53/1 | routed | - | 10.255.255.0/31 | default | 1500 | False | - | - |
| Ethernet2/1 | P2P_LINK_TO_DC1-LEAF1B_Ethernet53/1 | routed | - | 10.255.255.4/31 | default | 1500 | False | - | - |
...
interface Ethernet1/1
   description P2P_LINK_TO_DC1-LEAF1A_Ethernet53/1
   no shutdown
   mtu 1500
   no switchport
...
interface Ethernet2/1
   description P2P_LINK_TO_DC1-LEAF1B_Ethernet53/1
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65100
   ...
   neighbor 10.255.255.1 description dc1-leaf1a_Ethernet53/1
   neighbor 10.255.255.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.5 remote-as 65101
   neighbor 10.255.255.5 description dc1-leaf1b_Ethernet53/1

...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | MGMT | 192.168.3.101/24 | 192.168.3.1 |
...
| -------------- | ------------------- | --- | -------------- | -------------- | -------------- | ---------- |
| gzip | cv-staging.corp.arista.io:443 | MGMT | token-secure,/tmp/cv-onboarding-token | ale,flexCounter,hardware,kni,pulse,strata | /Sysdb/cell/1/agent,/Sysdb/cell/2/agent | True |
...
!
daemon TerminAttr
   exec /usr/bin/TerminAttr -cvaddr=cv-staging.corp.arista.io:443 -cvauth=token-secure,/tmp/cv-onboarding-token -cvvrf=MGMT -disableaaa -smashexcludes=ale,flexCounter,hardware,kni,pulse,strata -ingestexclude=/Sysdb/cell/1/agent,/Sysdb/cell/2/agent -taillogs
   no shutdown
```
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_WCC1_Ethernet8 | - | 10.255.255.2/31 | default | 1500 | False | - | - |
...
!
interface Ethernet1
   description P2P_WCC1_Ethernet8
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65100
   ...
   neighbor 10.255.255.3 description WCC1_Ethernet8
   neighbor 10.255.255.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.7 remote-as 65101
   neighbor 10.255.255.7 description WCC2_Ethernet8
